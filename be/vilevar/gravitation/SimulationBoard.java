...
public class SimulationBoard {
	...
	public Scene createScene() {
		// Set the save to null for the next time
		SimulationBoard.save = null;
		...
		ToolBar toolbar = new ToolBar(precision, dt, speed, keep, pause, save, stop);
	...
	//	if(height == 0) height = 800;
		...
		return new Vec2d(pos.getX() + (800 / 2), -pos.getY() + (800 / 2));
	}
